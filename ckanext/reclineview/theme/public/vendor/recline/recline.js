    ...
    <div class="recline-flot"> \
      <div class="panel graph" style="display: block;"> \
        <div class="js-temp-notice alert alert-warning alert-block"> \
          <p>右側から「グラフの種類」、「主軸」、「副軸」を選択してください。副軸を追加する場合は、「副軸の追加」をクリックしてください。</p> \
        </div> \
      </div> \
    </div> \
',
  ...
  <div class="editor"> \
    <form class="form-stacked"> \
        ...
        <div class="form-group"> \
          ...
          <div class="input editor-type"> \
            <select class="form-control"> \
              <option value="lines-and-points">線+点グラフ</option> \
              <option value="lines">線グラフ</option> \
              <option value="points">点グラフ</option> \
              <option value="bars">棒グラフ（縦）</option> \
              <option value="columns">棒グラフ（横）</option> \
            </select> \
          </div> \
        </div> \
        <div class="form-group"> \
      ...
      <div class="editor-buttons"> \
        <button class="btn btn-default editor-add">副軸の点グラフ</button> \
      </div> \
...
',
  templateSeriesEditor: ' \
    <div class="editor-series js-series-{{seriesIndex}}"> \
      <div class="form-group"> \
        <label>副軸 <span>{{seriesName}} </span> \
          [<a href="#remove" class="action-remove-series">削除</a>] \
        </label> \
        <div class="input"> \
          <select class="form-control"> \
          {{#fields}} \
...
',
  ...
  _setupMap: function(){
    ...
    this.map.setView([34.486134, 132.520523], 10);
...
my.MapMenu = Backbone.View.extend({
  ...
  template: ' \
    <form class="form-stacked"> \
      ...
      <div class="editor-buttons"> \
        <button class="btn btn-default editor-update-map">更新</button> \
      </div> \
    ...
    <form action="" method="GET" class="form-inline" role="form"> \
      <div class="form-group"> \
        <div class="input-group text-query"> \
          ...
          <input class="form-control search-query" type="text" id="q" name="q" value="{{q}}" placeholder="データ内検索"> \
        </div> \
      </div> \
